...
export default function Pagination({
  ...
  const visiblesPages = getVisiblesPages();
  return (
      ...
      {visiblesPages.map((page, key) => {
        ...
        return (
          <Link
            ...
            className={`px-3 py-2 text-sm font-medium ${isCurrentPage ? "bg-purple-600 text-white" : "text-gray-700 hover:bg-gray-100 border border-gray-300"}`}
          >
            {pageNumber}
          </Link>
        );
